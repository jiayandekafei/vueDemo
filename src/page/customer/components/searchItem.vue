  ...
  <div class="search_container searchArea">
        <el-form 
            ...
            <el-form-item class="btnRight">
                <el-button type="primary" size ="mini" icon="view" @click='onScreeoutCustomer()' :disabled="searchBtnDisabled">批量删除</el-button>
                <el-button type="primary" size ="mini" icon="view" @click='onScreeoutCustomer()'>添加</el-button>
            </el-form-item>
        </el-form>
    </div>
</template>
